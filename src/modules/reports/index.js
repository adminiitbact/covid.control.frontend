...
function Reports(props) {
  ...
  const download = formProps => {
    const req = ReportAPI.post({
      reportName: formProps.reporttype,
      jurisdiction: formProps.jurisdiction,
      startDate: dates[0],
      endDate: dates[1]
    });
    req.then(
  ...
  return (
    <>
      ...
      <Content>
        ...
        <Formik
          initialValues={{ reporttype: '', jurisdiction: '', date: [] }}
            ...
            <Row>
              <Col span={8}>
                <Form.Item name='reporttype' label='SELECT REPORT TYPE'>
                  ...
                  >
                    <Select.Option value='SUM_ISOLATION_TOTAL_PATIENT'>
                      Sum Isolation Total Patients Hospital Wise
                    </Select.Option>
                    <Select.Option value='Positive Patients Line List'>
                      Positive Patients Line List
                    </Select.Option>
                    <Select.Option value='DAILY_PATIENT_DISCHARGE_LIST'>
                      Daily Patient Discharge List
                    </Select.Option>
                    <Select.Option value='DAILY_PATIENT_DEATH_LIST'>
                      Daily Patient Death List
                    </Select.Option>
                    <Select.Option value='COVID Facilities Details'>
                      COVID Facilities Details
                    </Select.Option>
                    <Select.Option value='COVID_FACILITIES_SUMMARY'>
                      COVID Facilities Summary
                    </Select.Option>
                  </Select>
                </Form.Item>
              </Col>
